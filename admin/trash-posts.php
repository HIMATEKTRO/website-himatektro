...
$query=mysqli_query($con,"update table_posts set Is_Active=1 where id='$postid'");
if($query)
{
...
if($_GET['presid'])
{
    ...
    $query=mysqli_query($con,"delete from  table_posts  where id='$id'");
...
<?php
$query=mysqli_query($con,"select table_posts.id as postid, table_posts.PostTitle as title, table_category.CategoryName as category, table_subcategory.Subcategory as subcategory from table_posts left join table_category on table_category.id=table_posts.CategoryId left join table_subcategory on table_subcategory.SubCategoryId=table_posts.SubCategoryId where table_posts.Is_Active=0");
