...
if(isset($_POST['login']))
{
    ...
    $sql =mysqli_query($con,"SELECT AdminUserName,AdminEmailId,AdminPassword FROM table_admin WHERE (AdminUserName='$uname' || AdminEmailId='$uname')");
    ...
    if(mysqli_num_rows($sql) > 0)
    {
        ...
        if (password_verify($password, $hashpassword)) {
            ...
            $_SESSION['nama'] = $num['AdminUserName'];
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Portal Admin HIMATEKTRO | Login</title>
