...
if( $_GET['disid'])
{
	...
	$query=mysqli_query($con,"update table_comments set status='0' where id='$id'");
...
if($_GET['appid'])
{
	...
	$query=mysqli_query($con,"update table_comments set status='1' where id='$id'");
...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"delete from  table_comments  where id='$id'");
...
<html lang="en">
    <head>
        ...
        <title>Portal Admin HIMATEKTRO | Manage Cooments</title>
											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select table_comments.id,  table_comments.name, table_comments.email, table_comments.postingDate, table_comments.comment,table_posts.id as postid, table_posts.PostTitle from  table_comments join table_posts on table_posts.id=table_comments.postId where table_comments.status=1");
$cnt=1;
