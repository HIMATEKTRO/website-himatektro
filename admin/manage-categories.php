...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"update table_category set Is_Active='0' where id='$id'");
...
if($_GET['resid'])
{
	...
	$query=mysqli_query($con,"update table_category set Is_Active='1' where id='$id'");
...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"delete from  table_category  where id='$id'");
...
<html lang="en">
    <head>
        ...
        <title>Portal Admin HIMATEKTRO | Manage Categories</title>
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select id,CategoryName,Description,PostingDate,UpdationDate from  table_category where Is_Active=1");
$cnt=1;
...
<table class="table m-0 table-colored-bordered table-bordered-danger">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select id,CategoryName,Description,PostingDate,UpdationDate from  table_category where Is_Active=0");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>
