...
{
	$id=intval($_GET['scid']);
	$query=mysqli_query($con,"update table_subcategory set Is_Active='0' where SubCategoryId='$id'");
...
if($_GET['resid'])
{
	...
	$query=mysqli_query($con,"update table_subcategory set Is_Active='1' where SubCategoryId='$id'");
...
{
	$id=intval($_GET['scid']);
	$query=mysqli_query($con,"delete from table_subcategory  where SubCategoryId='$id'");
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select table_category.CategoryName as catname, table_subcategory.Subcategory as subcatname, table_subcategory.SubCatDescription as SubCatDescription, table_subcategory.PostingDate as subcatpostingdate, table_subcategory.UpdationDate as subcatupdationdate, table_subcategory.SubCategoryId as subcatid from table_subcategory join table_category on table_subcategory.CategoryId=table_category.id where table_subcategory.Is_Active=1");
$cnt=1;
...
<div class="table-responsive">
   <table class="table m-0 table-colored-bordered table-bordered-danger">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select table_category.CategoryName as catname, table_subcategory.Subcategory as subcatname, table_subcategory.SubCatDescription as SubCatDescription, table_subcategory.PostingDate as subcatpostingdate, table_subcategory.UpdationDate as subcatupdationdate, table_subcategory.SubCategoryId as subcatid from table_subcategory join table_category on table_subcategory.CategoryId=table_category.id where table_subcategory.Is_Active=0");
$cnt=1;
$rowcount=mysqli_num_rows($query);
if($rowcount==0)
{
