...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>HIMATEKTRO | Dashboard</title>
...
<?php $query=mysqli_query($con,"select * from table_category where Is_Active=1");
...
<?php $query=mysqli_query($con,"select * from table_subcategory where Is_Active=1");
...
<?php $query=mysqli_query($con,"select * from table_posts where Is_Active=1");
...
<?php $query=mysqli_query($con,"select * from table_posts where Is_Active=0");
$countposts=mysqli_num_rows($query);
?>
                                        <h2><?php echo htmlentities($countposts);?> <small></small></h2>
