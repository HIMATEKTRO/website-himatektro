...
$sql=mysqli_query($con,"SELECT AdminPassword FROM  table_admin where AdminUserName='$adminid' || AdminEmailId='$adminid'");
...
<html lang="en">
    <head>
        ...
        <title>Portal Admin HIMATEKTRO | Change Password</title>
