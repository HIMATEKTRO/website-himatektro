...
$query=mysqli_query($con,"update table_posts set PostTitle='$posttitle',CategoryId='$catid',SubCategoryId='$subcatid',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status' where id='$postid'");
if($query)
{
$msg="Post updated ";
}
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>HIMATEKTRO | Add Post</title>
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select table_posts.id as postid, table_posts.PostImage, table_posts.PostTitle as title, table_posts.PostDetails, table_category.CategoryName as category, table_category.id as catid, table_subcategory.SubCategoryId as subcatid, table_subcategory.Subcategory as subcategory from table_posts left join table_category on table_category.id=table_posts.CategoryId left join table_subcategory on table_subcategory.SubCategoryId=table_posts.SubCategoryId where table_posts.id='$postid' and table_posts.Is_Active=1 ");
