...
$query=mysqli_query($con,"update table_pages set PageTitle='$pagetitle',Description='$pagedetails' where PageName='$pagetype' ");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>HIMATEKTRO | Contact us Page</title>
