											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select table_comments.id,  table_comments.name, table_comments.email, table_comments.postingDate, table_comments.comment, table_posts.id as postid, table_posts.PostTitle from  table_comments join table_posts on table_posts.id=table_comments.postId where table_comments.status=0");
$cnt=1;
