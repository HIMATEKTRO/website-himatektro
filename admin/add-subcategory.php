...
$status=1;
$query=mysqli_query($con,"insert into table_subcategory(CategoryId,Subcategory,SubCatDescription,Is_Active) values('$categoryid','$subcatname','$subcatdescription','$status')");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>HIMATEKTRO | Add Sub Category</title>
