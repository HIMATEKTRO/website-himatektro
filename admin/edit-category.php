...
$query=mysqli_query($con,"Update  table_category set CategoryName='$category',Description='$description' where id='$catid'");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>HIMATEKTRO | Add Category</title>
...
<?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($con,"Select id,CategoryName,Description,PostingDate,UpdationDate from  table_category where Is_Active=1 and id='$catid'");
$cnt=1;
